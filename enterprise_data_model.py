# -*- coding: utf-8 -*-
"""Enterprise_Data_Model.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Ch3gxnigrAVW1aUp5eJh2zASHwqmwj57
"""
...
# This is a closed loop use case since the operation is automatically paused when the sensor does not work and maintenance is alerted real-time.
...
In dyeing, process data operates in a closed loop system, where sensors provide feedback for automatic adjustments,

while water parameter monitoring typically functions as an open loop system, with data used for manual or periodic corrective actions
"""
